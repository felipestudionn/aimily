...
- [ ] **Etiquetas de bloque 1-4**: NO tocadas — son variantes de énfasis (no contradicción). Dos decisiones de marca pendientes de Felipe: bloque 1 "Brand" (app) vs "Trends" (pitch); bloque 4 "Sales" (app) vs "Launch" (pitch/web). Cuando Felipe elija, se unifican web+app en una pasada.
