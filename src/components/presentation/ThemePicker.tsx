...
export function ThemePicker({ current, onChange }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          className="absolute right-0 top-full mt-2 w-[420px] max-h-[70vh] overflow-y-auto bg-white rounded-[16px] shadow-[0_20px_60px_rgba(0,0,0,0.18)] border border-carbon/[0.06] p-2 z-50"
        >
          {THEMES.map((theme) => {
