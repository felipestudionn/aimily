/**
 * POST /api/strategy/buy-strategy-prefill-editor
 *
...
import { buildBuyStrategyPrefillPrompt, type BuyStrategyPrefillEditor } from '@/lib/strategy/buy-strategy-prompts';
