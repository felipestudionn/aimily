/**
 * GET /api/strategy/seeds?tenant_slug=<slug>&status=<status>
 *
 ...
 *
 * Note: route lives under /api/strategy/seeds for now because the rest of
 * the In-Season API still uses /api/strategy/* — when the Sprint A rename
