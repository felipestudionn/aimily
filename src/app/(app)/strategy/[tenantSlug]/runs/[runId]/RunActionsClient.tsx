  ...
  return (
    <div className="flex flex-col items-end gap-2">
      <div className="flex flex-wrap gap-2 justify-end">
        {canExecute && (
          <button
            onClick={() => post(`/api/strategy/runs/${runId}/execute`, 'execute')}
            disabled={busy != null}
        ...
        {isComplete && (
          <>
            <button
              onClick={() => post(`/api/strategy/runs/${runId}/backtest`, 'backtest')}
              disabled={busy != null}
            ...
            <button
              onClick={() => post(`/api/strategy/runs/${runId}/narrate`, 'narrate')}
              disabled={busy != null}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-carbon/[0.12] text-carbon/70 text-[12px] font-semibold hover:bg-carbon/[0.04] disabled:opacity-50"
            >
              {busy === 'narrate' ? (
      ...
      {isComplete && (
        <div className="flex flex-wrap gap-2 items-center justify-end mt-1">
          ...
          <button
            onClick={() =>
              post(`/api/strategy/runs/${runId}/propose-skus`, 'propose-skus', { count: 8 })
            }
            disabled={busy != null}
          ...
          <button
            onClick={() =>
              post(`/api/strategy/runs/${runId}/propose-extensions`, 'propose-extensions', {
                count: 4,
              })
            }
            disabled={busy != null}
          ...
          {familyCodes.length > 0 && (
            <>
              ...
              <button
                onClick={() =>
                  paletteFamily &&
                  post(`/api/strategy/runs/${runId}/recommend-palette`, 'recommend-palette', {
