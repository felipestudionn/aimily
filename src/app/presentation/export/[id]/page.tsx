...
export default async function PresentationExportPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="w-full" style={{ background: '#fff' }}>
      ...
      {/* Notes & Disclaimers — final slide. Required for any deck that
          may circulate publicly (PDF download, /p/[token] share link).
          Names third-party brands as inspiration not endorsement, makes
          the AI/draft nature of the content explicit, and stamps the
          generation date so a reader can tell how fresh the figures are. */}
      <div
        className="pdf-slide"
        style={{
          ...themeStyle(theme),
      ...
      >
        <div>
          <div style={{ fontSize: '10px', letterSpacing: '0.18em', textTransform: 'uppercase', opacity: 0.55, marginBottom: '32px' }}>
            Notes &amp; Disclaimers
          </div>
          <p style={{ fontSize: '14px', lineHeight: 1.65, opacity: 0.78, maxWidth: '900px', marginBottom: '20px' }}>
            This presentation is a working document generated by aimily for{' '}
            <strong>{meta.collectionName}</strong>. Figures, narratives and visuals
            represent the brand&rsquo;s internal planning and are subject to revision.
          </p>
          <p style={{ fontSize: '14px', lineHeight: 1.65, opacity: 0.78, maxWidth: '900px', marginBottom: '20px' }}>
            References to third-party brands, products, designers, retailers or
            cultural figures appearing in this deck are <strong>aspirational
            inspiration only</strong> &mdash; not endorsements, partnerships,
            licensing arrangements or claims of affiliation. All trademarks remain
            the property of their respective owners.
          </p>
          <p style={{ fontSize: '14px', lineHeight: 1.65, opacity: 0.78, maxWidth: '900px', marginBottom: '20px' }}>
            AI-generated imagery and text are produced by third-party model
            providers and may contain inaccuracies. The brand owner is responsible
            for review and approval before any public commercial use.
          </p>
        </div>
        <div style={{ fontSize: '11px', opacity: 0.5, display: 'flex', justifyContent: 'space-between' }}>
          <span>aimily &middot; planning, design and launch for fashion collections</span>
          <span>Generated {new Date().toISOString().slice(0, 10)} &middot; StudioNN Agency S.L.</span>
        </div>
      </div>
