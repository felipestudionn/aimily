...
export const SALES_CHANNELS: SalesChannelDefinition[] = [
  {
    ...
    benchmark_brands: ['Nude Project', 'Skims', 'Djerf Avenue', 'Rouje', 'Baymo'],
...

  {
    ...
    benchmark_brands: ['Halara', 'FUFFI', 'ARMONIAS', 'Nurrk'],
...

  {
    ...
    benchmark_brands: ['Telfar', 'Mejuri', 'Gucci', 'Brunello Cucinelli'],
...

  {
    ...
    benchmark_brands: ['Conner Ives', 'Maitrepierre', 'FAIRE indies', 'Joor showroom'],
...

  {
    ...
    benchmark_brands: ['Hôtel Mahfouf', 'Baymo', 'Tipi Tent', 'Dolls Kill'],
...

  {
    ...
    benchmark_brands: ['Conner Ives', 'Susie Lau', 'Vinted Re/style', 'Depop top sellers'],
